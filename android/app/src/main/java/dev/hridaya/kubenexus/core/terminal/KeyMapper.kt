...
object KeyMapper {
    fun map(keyCode: Int, codepoint: Int, metaState: Int): MappedKey? {
        ...
        val mapped = when (keyCode) {
            ...
            KeyEvent.KEYCODE_F1 -> MappedKey(key = GhosttyKey.f1, codepoint = 0, mods = mods)
            KeyEvent.KEYCODE_F2 -> MappedKey(key = GhosttyKey.f2, codepoint = 0, mods = mods)
            KeyEvent.KEYCODE_F3 -> MappedKey(key = GhosttyKey.f3, codepoint = 0, mods = mods)
            KeyEvent.KEYCODE_F4 -> MappedKey(key = GhosttyKey.f4, codepoint = 0, mods = mods)
            KeyEvent.KEYCODE_F5 -> MappedKey(key = GhosttyKey.f5, codepoint = 0, mods = mods)
            KeyEvent.KEYCODE_F6 -> MappedKey(key = GhosttyKey.f6, codepoint = 0, mods = mods)
            KeyEvent.KEYCODE_F7 -> MappedKey(key = GhosttyKey.f7, codepoint = 0, mods = mods)
            KeyEvent.KEYCODE_F8 -> MappedKey(key = GhosttyKey.f8, codepoint = 0, mods = mods)
            KeyEvent.KEYCODE_F9 -> MappedKey(key = GhosttyKey.f9, codepoint = 0, mods = mods)
            KeyEvent.KEYCODE_F10 -> MappedKey(key = GhosttyKey.f10, codepoint = 0, mods = mods)
            KeyEvent.KEYCODE_F11 -> MappedKey(key = GhosttyKey.f11, codepoint = 0, mods = mods)
            KeyEvent.KEYCODE_F12 -> MappedKey(key = GhosttyKey.f12, codepoint = 0, mods = mods)
    ...
    private fun translateMods(metaState: Int): Int {
        var mods = 0
        if (metaState and KeyEvent.META_SHIFT_ON != 0) mods = mods or (1 shl 0)
        if (metaState and KeyEvent.META_CTRL_ON != 0) mods = mods or (1 shl 1)
        if (metaState and KeyEvent.META_ALT_ON != 0) mods = mods or (1 shl 2)
        if (metaState and KeyEvent.META_META_ON != 0) mods = mods or (1 shl 3)
        return mods
    }
}
