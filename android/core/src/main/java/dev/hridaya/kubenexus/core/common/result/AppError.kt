...
sealed interface AppError {
    ...
    data class Database(override val message: String = "Failed to access local database.") :
        AppError

    data class Validation(override val message: String) : AppError

    data class NotFound(override val message: String = "The requested resource was not found.") :
        AppError
